...
#define CLI_USAGE "Usage: application-memory-mcp cli [--progress] [--json] <tool_name> [json_args]\n"
...
static void print_help(void) {
    printf("application-memory-mcp %s\n\n", CBM_VERSION);
    printf("Usage:\n");
    printf("  application-memory-mcp              Run MCP server on stdio\n");
    printf("  application-memory-mcp cli [--progress] [--json] <tool> [args]\n");
    printf("                                      Run one tool locally, then exit\n");
    printf("  application-memory-mcp install [-y|-n] [--force] [--dry-run] "
           "[--dir=<path>] [--skip-config]\n");
    printf("  application-memory-mcp uninstall [-y|-n] [--dry-run]\n");
    printf("  application-memory-mcp update [-y|-n]\n");
    printf("  application-memory-mcp config <list|get|set|reset>\n");
    printf("  application-memory-mcp --version    Print version\n");
    printf("  application-memory-mcp --help       Print this help\n");
    printf("\nUI options:\n");
